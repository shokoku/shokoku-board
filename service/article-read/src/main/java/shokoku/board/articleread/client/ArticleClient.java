package shokoku.board.articleread.client;
...
public class ArticleClient {
  ...
  @Value("${endpoints.shokoku-board-article-service.url}")
  ...
  public Optional<ArticleResponse> read(Long articleId) {
    try {
      ...
      log.error("[ArticleClient] read error: articleId = {}", articleId, e);
  ...
  public ArticlePageResponse readAll(Long boardId, Long page, Long pageSize) {
    try {
      ...
      log.error("[ArticleClient.readAll] error: boardId = {}, page = {}, pageSize = {}", boardId, page, pageSize, e);
  ...
  public List<ArticleResponse> readAllInfiniteScroll(Long boardId, Long lastArticleId, Long pageSize) {
    try {
      ...
      log.error("[ArticleClient.readAllInfiniteScroll] error: boardId = {}, lastArticleId = {}, pageSize = {}", boardId, lastArticleId, pageSize, e);
      return List.of();
    }
  }
  ...
  public long count(Long boardId) {
    try {
      ...
      log.error("[ArticleClient.count] error: boardId = {}", boardId, e);
      return 0;
    }
  }
